    ...
    public class SqlHelper
    {
        ...
        public static Int32 ExecuteProcNonQuery(String procname, params SqlParameter[] parameters)
        {
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(@"Server=tcp:zoodotnet.database.windows.net,1433;Initial Catalog=zooDB;Persist Security Info=False;User ID=login;Password=Zoo1234!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"))
                {
                    conn.Open();
        ...
        {
            SqlConnection conn = new SqlConnection(@"Server=tcp:zoodotnet.database.windows.net,1433;Initial Catalog=zooDB;Persist Security Info=False;User ID=login;Password=Zoo1234!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
